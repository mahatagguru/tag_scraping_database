...
def print_final_summary(summaries: List[Dict[str, Any]]) -> None:
    ...
    for summary in summaries:
        ...
        if status == 'success':
            ...
            print(f"✅ {sport}: {summary.get('years_found', 0)} years, {summary.get('total_sets', 0)} sets")
...
Examples:
  ...
  python3 new_pipeline.py --all-sports --dry-run
    ...
    action_group.add_argument('--sport', type=str, help='Scrape a single sport (e.g., Baseball, Hockey)')
    action_group.add_argument('--all-sports', action='store_true', help='Scrape all known sports')
